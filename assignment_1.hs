...
substitute x n (Variable y)
    | y == x = n  -- This time, n is a variable
...
-- There may be infinite beta steps if the reduction is caught in a loop. In situations such as this, there will be no normal form.
normal :: Term -> Term
